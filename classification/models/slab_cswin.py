...
class CSWinTransformer(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dim=96, depth=[2, 2, 6, 2],
                 ...
                 drop_path_rate=0., hybrid_backbone=None, norm_layer=linearnorm, use_chk=False,
        ...
        self.merge1 = Merge_Block(curr_dim, curr_dim * 2, norm_layer=norm_layer)
        curr_dim = curr_dim * 2
        ...
        self.merge2 = Merge_Block(curr_dim, curr_dim * 2, norm_layer=norm_layer)
        curr_dim = curr_dim * 2
        ...
        self.merge3 = Merge_Block(curr_dim, curr_dim * 2, norm_layer=norm_layer)
        curr_dim = curr_dim * 2
...
def SLAB_CSWin_64_24181_tiny_224(pretrained=False, **kwargs):
...
def SLAB_CSWin_64_24322_small_224(pretrained=False, **kwargs):
